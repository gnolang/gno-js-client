// Auto-generated module for gno.land/r/sys/validators/v2 — DO NOT EDIT
import {
  GnoWallet,
...
const queryClient = (wallet: GnoWallet) => {
  return {
    async GetChanges(params: {
      from: bigint
    }, height?: number): Promise<GetChangesReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `GetChanges(${params.from})`, height);
      return _parseGnoReturns(result) as GetChangesReturn;
    },
    async NewPropRequest(params: {
      changesFn: unknown
      title: string
      description: string
    }, height?: number): Promise<NewPropRequestReturn> {
      ...
      return _parseGnoReturns(result) as NewPropRequestReturn;
    },
    async IsValidator(params: {
      addr: string
    }, height?: number): Promise<IsValidatorReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `IsValidator("${params.addr}")`, height);
      return _parseGnoReturns(result) as IsValidatorReturn;
    },
    async GetValidator(params: {
      addr: string
    }, height?: number): Promise<GetValidatorReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `GetValidator("${params.addr}")`, height);
      return _parseGnoReturns(result) as GetValidatorReturn;
    },
    async GetValidators(height?: number): Promise<GetValidatorsReturn> {
      ...
      return _parseGnoReturns(result) as GetValidatorsReturn;
    },
    async Render(params: {
      arg_0: string
...
const txClient = (wallet: GnoWallet) => {
  return {
    async GetChanges(params: {
      from: bigint
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<GetChangesReturn> {
    ...
    async NewPropRequest(params: {
      ...
      title: string
      description: string
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<NewPropRequestReturn> {
      const resp = await wallet.callMethod(
        realm,
        "NewPropRequest",
    ...
    async IsValidator(params: {
      addr: string
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<IsValidatorReturn> {
      const resp = await wallet.callMethod(
        realm,
        "IsValidator",
        [String(params.addr)],
    ...
    async GetValidator(params: {
      addr: string
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<GetValidatorReturn> {
      const resp = await wallet.callMethod(
        realm,
        "GetValidator",
        [String(params.addr)],
