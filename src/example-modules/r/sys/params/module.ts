...
const queryClient = (wallet: GnoWallet) => {
	return {
		async NewSetFeeCollectorRequest(params: { addr: string }, height?: number):Promise<NewSetFeeCollectorRequestReturn> {
		...
		async NewSysParamStringPropRequest(params: { module: string; submodule: string; name: string; value: string }, height?: number):Promise<NewSysParamStringPropRequestReturn> {
		...
		async NewSysParamInt64PropRequest(params: { module: string; submodule: string; name: string; value: bigint }, height?: number):Promise<NewSysParamInt64PropRequestReturn> {
		...
		async NewSysParamUint64PropRequest(params: { module: string; submodule: string; name: string; value: bigint }, height?: number):Promise<NewSysParamUint64PropRequestReturn> {
		...
		async NewSysParamBoolPropRequest(params: { module: string; submodule: string; name: string; value: boolean }, height?: number):Promise<NewSysParamBoolPropRequestReturn> {
		...
		async NewSysParamBytesPropRequest(params: { module: string; submodule: string; name: string; value: unknown }, height?: number):Promise<NewSysParamBytesPropRequestReturn> {
		...
		async NewSysParamStringsPropRequest(params: { module: string; submodule: string; name: string; value: unknown }, height?: number):Promise<NewSysParamStringsPropRequestReturn> {
		...
		async NewSysParamStringsPropRequestWithTitle(params: { module: string; submodule: string; name: string; title: string; value: unknown }, height?: number):Promise<NewSysParamStringsPropRequestWithTitleReturn> {
			...
			return parseGnoReturns(result) as NewSysParamStringsPropRequestWithTitleReturn;
		},
		async NewSysParamStringsPropRequestAddWithTitle(params: { module: string; submodule: string; name: string; title: string; value: unknown }, height?: number):Promise<NewSysParamStringsPropRequestAddWithTitleReturn> {
			...
			return parseGnoReturns(result) as NewSysParamStringsPropRequestAddWithTitleReturn;
		},
		async NewSysParamStringsPropRequestRemoveWithTitle(params: { module: string; submodule: string; name: string; title: string; value: unknown }, height?: number):Promise<NewSysParamStringsPropRequestRemoveWithTitleReturn> {
			...
			return parseGnoReturns(result) as NewSysParamStringsPropRequestRemoveWithTitleReturn;
		},
		...
		async ProposeAddUnrestrictedAcctsRequest(params: { addrs: unknown }, height?: number):Promise<ProposeAddUnrestrictedAcctsRequestReturn> {
			const result = await wallet.getProvider().evaluateExpression(realm, `ProposeAddUnrestrictedAcctsRequest(${params.addrs})`, height);
			return parseGnoReturns(result) as ProposeAddUnrestrictedAcctsRequestReturn;
		},
		async ProposeRemoveUnrestrictedAcctsRequest(params: { addrs: unknown }, height?: number):Promise<ProposeRemoveUnrestrictedAcctsRequestReturn> {
			const result = await wallet.getProvider().evaluateExpression(realm, `ProposeRemoveUnrestrictedAcctsRequest(${params.addrs})`, height);
			return parseGnoReturns(result) as ProposeRemoveUnrestrictedAcctsRequestReturn;
		}
	}
}
...
const txClient = (wallet: GnoWallet) => {
	return {
		async NewSetFeeCollectorRequest(params: { addr: string }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSetFeeCollectorRequestReturn> {
		...
		async NewSysParamStringPropRequest(params: { module: string; submodule: string; name: string; value: string }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamStringPropRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamInt64PropRequest(params: { module: string; submodule: string; name: string; value: bigint }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamInt64PropRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamUint64PropRequest(params: { module: string; submodule: string; name: string; value: bigint }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamUint64PropRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamBoolPropRequest(params: { module: string; submodule: string; name: string; value: boolean }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamBoolPropRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamBytesPropRequest(params: { module: string; submodule: string; name: string; value: unknown }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamBytesPropRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamStringsPropRequest(params: { module: string; submodule: string; name: string; value: unknown }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamStringsPropRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamStringsPropRequestWithTitle(params: { module: string; submodule: string; name: string; title: string; value: unknown }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamStringsPropRequestWithTitleReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamStringsPropRequestAddWithTitle(params: { module: string; submodule: string; name: string; title: string; value: unknown }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamStringsPropRequestAddWithTitleReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async NewSysParamStringsPropRequestRemoveWithTitle(params: { module: string; submodule: string; name: string; title: string; value: unknown }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<NewSysParamStringsPropRequestRemoveWithTitleReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async ProposeAddUnrestrictedAcctsRequest(params: { addrs: unknown }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<ProposeAddUnrestrictedAcctsRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
		...
		async ProposeRemoveUnrestrictedAcctsRequest(params: { addrs: unknown }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee):Promise<ProposeRemoveUnrestrictedAcctsRequestReturn> {
			const resp = await wallet.callMethod(
				realm,
