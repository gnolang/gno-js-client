// Auto-generated module for gno.land/r/gov/dao — DO NOT EDIT
import {
  GnoWallet,
...
const queryClient = (wallet: GnoWallet) => {
  return {
    ...
    async MustCreateProposal(params: {
      r: unknown
    }, height?: number): Promise<MustCreateProposalReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `MustCreateProposal(${params.r})`, height);
      return _parseGnoReturns(result) as MustCreateProposalReturn;
    },
    async ExecuteProposal(params: {
      pid: bigint
    }, height?: number): Promise<ExecuteProposalReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `ExecuteProposal(${params.pid})`, height);
      return _parseGnoReturns(result) as ExecuteProposalReturn;
    },
    async CreateProposal(params: {
      r: unknown
    }, height?: number): Promise<CreateProposalReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `CreateProposal(${params.r})`, height);
      return _parseGnoReturns(result) as CreateProposalReturn;
    },
    async MustVoteOnProposal(params: {
      r: unknown
    }, height?: number): Promise<void> {
      await wallet.getProvider().evaluateExpression(realm, `MustVoteOnProposal(${params.r})`, height);
      return;
    },
    async VoteOnProposal(params: {
      r: unknown
    }, height?: number): Promise<VoteOnProposalReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `VoteOnProposal(${params.r})`, height);
      return _parseGnoReturns(result) as VoteOnProposalReturn;
    },
    async MustVoteOnProposalSimple(params: {
      pid: bigint
      option: string
    }, height?: number): Promise<void> {
      await wallet.getProvider().evaluateExpression(realm, `MustVoteOnProposalSimple(${params.pid},"${params.option}")`, height);
      return;
    },
    async MustGetProposal(params: {
      pid: bigint
    }, height?: number): Promise<MustGetProposalReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `MustGetProposal(${params.pid})`, height);
      return _parseGnoReturns(result) as MustGetProposalReturn;
    },
    async GetProposal(params: {
      pid: bigint
    }, height?: number): Promise<GetProposalReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `GetProposal(${params.pid})`, height);
      return _parseGnoReturns(result) as GetProposalReturn;
    },
    async UpdateImpl(params: {
      r: unknown
    }, height?: number): Promise<void> {
      await wallet.getProvider().evaluateExpression(realm, `UpdateImpl(${params.r})`, height);
      return;
    },
    async AllowedDAOs(height?: number): Promise<AllowedDAOsReturn> {
      ...
      return _parseGnoReturns(result) as AllowedDAOsReturn;
    },
    async InAllowedDAOs(params: {
      pkg: string
    }, height?: number): Promise<InAllowedDAOsReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `InAllowedDAOs("${params.pkg}")`, height);
      return _parseGnoReturns(result) as InAllowedDAOsReturn;
    },
    async NewProposalRequest(params: {
      title: string
      description: string
    }, height?: number): Promise<NewProposalRequestReturn> {
      const result = await wallet.getProvider().evaluateExpression(realm, `NewProposalRequest("${params.title}","${params.description}")`, height);
      return _parseGnoReturns(result) as NewProposalRequestReturn;
    },
    async NewProposalRequestWithFilter(params: {
      title: string
      description: string
    }, height?: number): Promise<NewProposalRequestWithFilterReturn> {
      ...
      return _parseGnoReturns(result) as NewProposalRequestWithFilterReturn;
    },
    async NewProposals(height?: number): Promise<NewProposalsReturn> {
      ...
      return _parseGnoReturns(result) as NewProposalsReturn;
    },
    async NewSimpleExecutor(params: {
      callback: unknown
      description: string
    }, height?: number): Promise<NewSimpleExecutorReturn> {
      ...
      return _parseGnoReturns(result) as NewSimpleExecutorReturn;
    },
    async NewSafeExecutor(height?: number): Promise<NewSafeExecutorReturn> {
      ...
      return _parseGnoReturns(result) as NewSafeExecutorReturn;
    },
  };
};
...
const txClient = (wallet: GnoWallet) => {
  return {
    ...
    async MustCreateProposal(params: {
      r: unknown
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<MustCreateProposalReturn> {
      const resp = await wallet.callMethod(
        realm,
        "MustCreateProposal",
        [String(params.r)],
    ...
    async ExecuteProposal(params: {
      pid: bigint
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<ExecuteProposalReturn> {
      const resp = await wallet.callMethod(
        realm,
        "ExecuteProposal",
        [String(params.pid)],
    ...
    async CreateProposal(params: {
      r: unknown
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<CreateProposalReturn> {
      const resp = await wallet.callMethod(
        realm,
        "CreateProposal",
        [String(params.r)],
    ...
    async VoteOnProposal(params: {
      r: unknown
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<VoteOnProposalReturn> {
      const resp = await wallet.callMethod(
        realm,
        "VoteOnProposal",
        [String(params.r)],
    ...
    async MustGetProposal(params: {
      pid: bigint
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<MustGetProposalReturn> {
      const resp = await wallet.callMethod(
        realm,
        "MustGetProposal",
        [String(params.pid)],
    ...
    async GetProposal(params: {
      pid: bigint
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<GetProposalReturn> {
      const resp = await wallet.callMethod(
        realm,
        "GetProposal",
        [String(params.pid)],
    ...
    async InAllowedDAOs(params: {
      pkg: string
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<InAllowedDAOsReturn> {
      const resp = await wallet.callMethod(
        realm,
        "InAllowedDAOs",
        [String(params.pkg)],
    ...
    async NewProposalRequest(params: {
      title: string
      description: string
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<NewProposalRequestReturn> {
      const resp = await wallet.callMethod(
        realm,
        "NewProposalRequest",
    ...
    async NewProposalRequestWithFilter(params: {
      title: string
      description: string
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<NewProposalRequestWithFilterReturn> {
      const resp = await wallet.callMethod(
        realm,
    ...
    async NewSimpleExecutor(params: {
      callback: unknown
      description: string
    }, funds: Map<string, number>, maxDeposit: Map<string, number>, fee: TxFee): Promise<NewSimpleExecutorReturn> {
      const resp = await wallet.callMethod(
        realm,
        "NewSimpleExecutor",
