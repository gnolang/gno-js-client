...
- fix: surface the ABCI error returned by the node instead of a generic
  `ABCI response is not initialized` ([#250](https://github.com/gnolang/gno-js-client/issues/250))
